    ...
    <>
      <Card className="project-card-view">
        ...
        <Card.Body className="project-card-body">
          <Card.Title className="project-card-title" style={{ fontSize: "1rem" }}>
            <span className="purple">{props.title}</span>
          </Card.Title>
          ...
          <div className="project-card-buttons">
            ...
            >
              <BsGithub /> &nbsp; {t("projectCard.githubButton")}
            </Button>
            ...
            >
              <CgWebsite /> &nbsp; {t("projectCard.demoButton")}
            </Button>
          </div>
        </Card.Body>
      </Card>
      ...
      <Modal show={showModal} onHide={() => setShowModal(false)} centered size="lg">
        <Modal.Header closeButton>
          <Modal.Title>{t("projectCard.modal.title")}</Modal.Title>
        </Modal.Header>
        <Modal.Body className="text-center">
          <video width="100%" height="auto" controls>
            <source src={props.demoVideo} type="video/mp4" />
            {t("projectCard.modal.unsupported")}
          </video>
        </Modal.Body>
      </Modal>
    </>
